...
const messages = {
  "zh-CN": {
    ...
    "auth.tokenName": "令牌名称",
    "auth.tokenNamePlaceholder": "例如：XilerMo Desktop",
    ...
    "auth.registerTitle": "注册 XilerMo 账户",
    ...
    "admin.branding.statusDefault": "未自定义，使用 XilerMo 默认品牌",
    ...
    "admin.branding.productNamePlaceholder": "默认 XilerMo",
    ...
    "memory.contentPlaceholder": "例如：XilerMo 使用 D1 作为事实源",
    ...
    "projects.namePlaceholder": "例如：XilerMo",
    ...
    "pwa.installDescription":
      "把 XilerMo 装到桌面或主屏幕，像原生应用一样打开，并支持离线记录与自动同步。",
    "pwa.installButton": "安装 XilerMo",
  ...
  "en-US": {
    ...
    "capture.cleanupFailed":
      "The memo is saved in XilerMo, but its local recovery copy could not be removed. Retry cleanup.",
    ...
    "capture.description":
      "XilerMo will use your microphone to transcribe after you start.",
    ...
    "auth.tokenNamePlaceholder": "For example: XilerMo Desktop",
    ...
    "auth.registerTitle": "Create a XilerMo account",
    ...
    "auth.registrationStatusUnavailable":
      "XilerMo could not read the registration status. Check your connection and try again.",
    ...
    "admin.branding.statusDefault": "Using the XilerMo default brand",
    "admin.resetLinkDescription":
    ...
    "admin.branding.productNamePlaceholder": "Default: XilerMo",
    ...
    "memory.contentPlaceholder": "e.g. XilerMo uses D1 as the source of truth",
    ...
    "projects.namePlaceholder": "e.g. XilerMo",
    ...
    "pwa.installDescription":
      "Install XilerMo to your desktop or home screen to open it like a native app, with offline capture and automatic sync.",
    "pwa.installButton": "Install XilerMo",
