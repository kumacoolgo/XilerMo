...
const messages = {
  "zh-CN": {
    ...
    "visibility.publicConfirm": "设为全网公开后，任何人均可访问。确定继续吗？",
    "memo.restore": "恢复",
    "memo.pin": "置顶",
    ...
    "auth.brandEyebrow": "你的思考空间",
    "auth.brandTitle": "把每个瞬间，变成可找回的记忆。",
    "auth.brandDescription": "记录、整理、回顾，也让 AI 在你的边界内协助工作。",
    "auth.brandPointCapture": "快速记录",
    "auth.brandPointMemory": "长期记忆",
    "auth.brandPointOwnership": "数据归你",
    ...
    "auth.tab.transfer": "数据传输",
    "transfer.title": "数据传输",
    "transfer.description": "查看最近的导入和导出任务及其处理状态。",
  ...
  "en-US": {
    ...
    "visibility.publicConfirm":
      "Anyone on the internet will be able to access this. Continue?",
    ...
    "auth.brandEyebrow": "Your thinking space",
    "auth.brandTitle": "Turn every moment into memory you can find.",
    "auth.brandDescription":
      "Capture, organize, and revisit your notes while AI works within your boundaries.",
    "auth.brandPointCapture": "Capture fast",
    "auth.brandPointMemory": "Remember longer",
    "auth.brandPointOwnership": "Keep ownership",
    ...
    "auth.tab.transfer": "Transfer",
    "transfer.title": "Data transfer",
    "transfer.description":
      "Review recent import and export tasks and their processing state.",
